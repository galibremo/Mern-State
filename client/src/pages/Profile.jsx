  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form className="flex flex-col gap-4">
        ...
        <input type="" id="username" placeholder="username" className="border p-3 rounded-lg"/>
        <input type="" id="email" placeholder="email" className="border p-3 rounded-lg"/>
        <input type="" id="password" placeholder="password" className="border p-3 rounded-lg"/>
